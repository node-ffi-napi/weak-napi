...
const proxyHandler = {
  ...
  isExtensible(info) {
    const target = info.target;
    return target === undefined ? false : Object.isExtensible(target);
  },
  preventExtensions(info) {
    const target = info.target;
    return target === undefined ? false : Object.preventExtensions(target);
  },
  ...
  deleteProperty(info, key) {
    const target = info.target;
    return target === undefined ? false : delete target[key];
  },
  ownKeys(info) {
    const target = info.target;
